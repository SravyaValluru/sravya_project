...
function validate(field)
{
	...
	if(field=='firstname')
			...
			else if(field=='useremail')
			{
				...
				temp=document.getElementById("e1").value;
			...
			else if(field=='sname')
			{
				...
				{
					document.getElementById("error_shopname").style.display="block";
					sname=false;
				}	
				else
				{
			...
			if((firstname==true)&&(lastname==true)&&(useremail==true)&&(password==true)&&(confirm_password==true)&&(sname == true))
			{
